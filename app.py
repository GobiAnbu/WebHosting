        ...
        if text_lower.startswith("cmd_"):
            ...
            if text_lower == "cmd_reminder":
                ...
                reply = (
                    ...
                    f"———————————\n\n"
                    f"🔔 *{chit_n}* அறிவிப்பு\n\n"
                    f"இந்த மாதத்திற்கான உங்கள் சிட் தொகையான *₹{amount}* இன்னும் செலுத்தப்படவில்லை என்றால், தயவுசெய்து செலுத்தவும்.\n\n"
                    f"💳 Gpay/PhonePe க்கு *{gpay}*\n\n"
                    f"Thank you! 🙏"
                )
                send_whatsapp_message(from_number, reply)
            ...
            if text_lower == "cmd_tomorrow":
                ...
                reply = (
                    ...
                    f"———————————\n\n"
                    f"🔔 *அறிவிப்பு: {chit_n} - நாளை சிட்!*\n\n"
                    f"வணக்கம் 👋,\n\n"
                    f"நாளை *({tomorrow_str})* நமது *{chit_n}* சிட் நடைபெறும் என்பதை தெரிவித்துக் கொள்கிறோம்.\n\n"
                    f"📌 *சிட் எண்:* {chit_num}\n\n"
                    f"நீங்கள் சிட் எடுக்க விரும்பினால், தயவுசெய்து கலந்து கொள்ளுங்கள்.\n\n"
                    f"📞 *தொடர்பு எண்:* {contact} (கலந்துகொள்ள விருப்பமுள்ளவர்கள் இந்த எண்ணை தொடர்பு கொள்ளலாம்.)\n\n"
                    f"நன்றி! 🙏"
                )
                send_whatsapp_message(from_number, reply)
                _send_command_menu(from_number, chit_name, "What would you like to do next?")
